package sensor_network.centralized.benefit.graph;
...
public class QEdgeForest extends JPanel implements Runnable {
	private static final long serialVersionUID = 1L;
	
	private Map<Integer, Axis> nodes;
	//private Map<Integer, Axis> dataNodes;
    ...
    private Map<Integer, ConnectedComponent> connectedComponents;
    private List<Edge> qEdges;
	...
	public List<Edge> getQEdges() {
		return this.qEdges;
	}
	
	public void setQEdges(List<Edge> q) {
		this.qEdges = q;
	}
	
	public Map<Integer, ConnectedComponent> getConnectedComponents() {
		return connectedComponents;
	}

	public void setConnectedComponents(Map<Integer, ConnectedComponent> _connectedComponents) {
		this.connectedComponents = _connectedComponents;
	}
	...
	protected void paintComponent(Graphics g) {
       ...
       g2.fillRect(scaling - 25, scaling - 25, getWidth(), getHeight());
       ...
       for (Edge edge: this.qEdges) {
    	   int node1 = edge.getNode1();
    	   int node2 = edge.getNode2();
    	   int x1 = graphPoints.get(node1).x;
           int y1 = graphPoints.get(node1).y;
           int x2 = graphPoints.get(node2).x;
           int y2 = graphPoints.get(node2).y;
	...
	public void run() {
		String graphName= "Q-MTSSR (Algo 3) ";
