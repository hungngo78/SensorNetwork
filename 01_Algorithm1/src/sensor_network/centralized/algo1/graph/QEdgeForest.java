...
public class QEdgeForest extends JPanel implements Runnable {
	...
	protected void paintComponent(Graphics g) {
       ...
       for (Edge edge: this.qEdges) {
    	   ...
    	   int x1 = graphPoints.get(node1-1).x;
           int y1 = graphPoints.get(node1-1).y;
           int x2 = graphPoints.get(node2-1).x;
           int y2 = graphPoints.get(node2-1).y;
	...
	public void run() {
		String graphName= "Minimum Spanning Tree (centralized)";
