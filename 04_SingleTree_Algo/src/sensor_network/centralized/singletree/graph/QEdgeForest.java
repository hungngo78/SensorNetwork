package sensor_network.centralized.singletree.graph;
...
public class QEdgeForest extends JPanel implements Runnable {
	...
	public ArrayList<Edge> getQEdges() {
		return this.qEdges;
	}
	
	public void setQEdges(ArrayList<Edge> q) {
		this.qEdges = q;
	}
	...
	public void setConnectedComponents(Map<Integer, Set<Integer>> list) {
	...
	protected void paintComponent(Graphics g) {
       ...
       g2.fillRect(scaling, scaling, getWidth(), getHeight());
       ...
       for (int key: connectedComponents.keySet()) {
    	   ...
    	   for (int node: connectedComponent) {
    		   // find its adjacents  
    		   Set<Integer> adjs =  adjList.get(node);
    		   for (int adj: adjs) {
	...
	public void run() {
		String graphName= "Q-MTSSR (Algo 4 existing work)";
